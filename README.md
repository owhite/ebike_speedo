...
** note, for reasons that are unclear, be sure to hold down the pushbutton on A11 pin of the ESP32 feather to initiate programming. This is annoying but simply disconnecting didnt work either. 
